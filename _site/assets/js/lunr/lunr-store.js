var store = [{
        ...
        "excerpt":"# Ranking data Ranking data are common in survey-based research. Ranking data arise from survey questions in which a respondent is asked to rank a set of items by their priority or preference in the view of the respondent. I have recently encountered this type of data in my consulting...","categories": ["Common","issues"],
        "tags": [],
